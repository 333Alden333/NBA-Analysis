...
- [x] 02-03-PLAN.md — Matchup features (FEAT-03) + team features (FEAT-04) with tests
...
Plans:
- [ ] 03-01-PLAN.md — Prediction DB models, ML dependencies, BasePredictor framework
...
| 3. Prediction Models | 0/4 | Not started | - |
