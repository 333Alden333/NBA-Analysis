...
from hermes.dashboard.data_access import (
    get_team_features,
    get_team_games,
    get_team_info,
    get_team_standings,
)
from hermes.dashboard.components.charts import team_ratings_chart, team_record_chart
...
def _standings_overview():
    ...
    if not standings:
        st.warning("No standings data. Run `hermes sync --daily` to populate data.")
        return
